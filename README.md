...
a.	Box to LED light flash for Muse 
b.	Box to BNC  - for brain products 
c.	Box to Audio - for brain products [3-pin 2.5 mm phone jack; TTL (LVTTL) signals, 0 to +5 V (+ 3.3 V); active low]
d.	Box to DVXplorer  
